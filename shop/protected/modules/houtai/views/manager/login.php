                                ...
                                <div class="user_main_box">
                                    <ul>
                                        ...
                                        <li class="user_main_input">
                                            <?php echo $form->textField($user_login,'username',array('maxlength'=>20,'class'=>"TxtUserNameCssClass"));?>
                                            <?php echo $form->error($user_login,'username');?>
                                        </li></ul>
                                    <ul>
                                        <li class="user_main_text"><?php echo $form->labelEx($user_login,'password');?></li>
                                        <li class="user_main_input">
                                            <?php echo $form->passwordField($user_login,'password',array('class'=>"TxtUserNameCssClass"));?>
